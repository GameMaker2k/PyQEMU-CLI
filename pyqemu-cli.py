...
qemuimghelplistp = subprocess.Popen([qemuimgllocatout, '--help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemuimglhelpout, qemuimglhelperr = qemuimghelplistp.communicate();
qemuimglformatsprelist = re.findall("Supported formats: ([\w\_ ]+)\n", qemuimglhelpout, flags=re.MULTILINE)[0];
qemuimglformatslist = qemuimglformatsprelist.split(" ");
qemuimglformatsnlist = listize(qemuimglformatslist);
qemuimglversion = re.findall("^qemu-img version ([\w\_\. \-]+)\,", qemuimglhelpout, flags=re.MULTILINE)[0].strip();


qemu32llocatout = which_exec(qemu32execname);
qemu32helplistp = subprocess.Popen([qemu32llocatout, '--help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu32lhelpout, qemu32lhelperr = qemu32helplistp.communicate();
qemu32lverfull = re.findall("QEMU emulator version ([\w\_\.\+\(\) \-]+)\, Copyright", qemu32lhelpout, flags=re.MULTILINE)[0].strip();
qemu32lversion = re.findall("([\w\_\. \-]+)", qemu32lverfull, flags=re.MULTILINE)[0].strip();
qemu32lvgaprelist = re.findall("vga \[([\w\|]+)\]\n", qemu32lhelpout, flags=re.MULTILINE)[0];
qemu32lvgalist = qemu32lvgaprelist.split("|");
qemu32lvganlist = listize(qemu32lvgalist);
qemu32lrtcbaseprelist = re.findall("\[base\=([\w\|]+)\]", qemu32lhelpout, flags=re.MULTILINE)[0];
qemu32lrtcbaselist = qemu32lrtcbaseprelist.split("|");
qemu32lrtcbasenlist = listize(qemu32lrtcbaselist);
qemu32lrtcclockprelist = re.findall("\[\,clock\=([\w\|]+)\]", qemu32lhelpout, flags=re.MULTILINE)[0];
qemu32lrtcclocklist = qemu32lrtcclockprelist.split("|");
qemu32lrtcclocknlist = listize(qemu32lrtcclocklist);
qemu32lrtcdriftfixprelist = re.findall("\[\,driftfix\=([\w\|]+)\]", qemu32lhelpout, flags=re.MULTILINE)[0];
qemu32lrtcdriftlist = qemu32lrtcdriftfixprelist.split("|");
qemu32lrtcdriftnlist = listize(qemu32lrtcdriftlist);
qemu32cpulistp = subprocess.Popen([qemu32llocatout, '-cpu', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu32lcpuout, qemu32lcpuerr = qemu32cpulistp.communicate();
qemu32lcpulist = re.findall("^x86\s\s+([\w]+)  ([\s]+|[\w\(\)\.\@\_\/ \-]+)\n", qemu32lcpuout, flags=re.MULTILINE);
qemu32lcpunlist = twolistize(qemu32lcpulist);
qemu32machinelistp = subprocess.Popen([qemu32llocatout, '-machine', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu32lmachineout, qemu32lmachineerr = qemu32machinelistp.communicate();
qemu32lmachinelist = re.findall("^([\w\-\.]+)\s\s+([\w\(\)\+\,\. \-]+)\n", qemu32lmachineout, flags=re.MULTILINE);
qemu32lmachinenlist = twolistize(qemu32lmachinelist);
qemu32soundhwlistp = subprocess.Popen([qemu32llocatout, '-soundhw', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu32lsoundhwout, qemu32lsoundhwerr = qemu32soundhwlistp.communicate();
qemu32lsoundhwlist = re.findall("^([\w]+)\s\s+([\w\(\) ]+)\n", qemu32lsoundhwout, flags=re.MULTILINE);
qemu32lsoundhwlist.append(('all', 'Enable all sound cards'));
qemu32lsoundhwnlist = twolistize(qemu32lsoundhwlist);
qemu32larglist = arglistize(qemu32llocatout, ('-hda', '/dev/null'), ('-cdrom', '/home/cooldude2k/Emu/Minix3/minix_R3.3.0-588a35b.iso'), ('-boot', 'order=acd,once=d,menu=on'), ('-cpu', qemu32lcpunlist['name']['reg'][9]), ('-machine', qemu32lmachinenlist['name']['reg'][16]), ('-soundhw', qemu32lsoundhwnlist['name']['reg'][8]), ('-sdl', None));
...
qemu64helplistp = subprocess.Popen([qemu64llocatout, '--help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu64lhelpout, qemu64lhelperr = qemu64helplistp.communicate();
qemu64lverfull = re.findall("QEMU emulator version ([\w\_\.\+\(\) \-]+)\, Copyright", qemu64lhelpout, flags=re.MULTILINE)[0].strip();
qemu64lversion = re.findall("([\w\_\. \-]+)", qemu64lverfull, flags=re.MULTILINE)[0].strip();
qemu64lvgaprelist = re.findall("vga \[([\w\|]+)\]\n", qemu64lhelpout, flags=re.MULTILINE)[0];
qemu64lvgalist = qemu64lvgaprelist.split("|");
qemu64lvganlist = listize(qemu64lvgalist);
qemu64lrtcbaseprelist = re.findall("\[base\=([\w\|]+)\]", qemu64lhelpout, flags=re.MULTILINE)[0];
qemu64lrtcbaselist = qemu64lrtcbaseprelist.split("|");
qemu64lrtcbasenlist = listize(qemu64lrtcbaselist);
qemu64lrtcclockprelist = re.findall("\[\,clock\=([\w\|]+)\]", qemu64lhelpout, flags=re.MULTILINE)[0];
qemu64lrtcclocklist = qemu64lrtcclockprelist.split("|");
qemu64lrtcclocknlist = listize(qemu64lrtcclocklist);
qemu64lrtcdriftfixprelist = re.findall("\[\,driftfix\=([\w\|]+)\]", qemu64lhelpout, flags=re.MULTILINE)[0];
qemu64lrtcdriftlist = qemu64lrtcdriftfixprelist.split("|");
qemu64lrtcdriftnlist = listize(qemu64lrtcdriftlist);
qemu64cpulistp = subprocess.Popen([qemu64llocatout, '-cpu', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu64lcpuout, qemu64lcpuerr = qemu64cpulistp.communicate();
qemu64lcpulist = re.findall("^x86\s\s+([\w]+)  ([\s]+|[\w\(\)\.\@\_\/ \-]+)\n", qemu64lcpuout, flags=re.MULTILINE);
qemu64lcpunlist = twolistize(qemu64lcpulist);
qemu64machinelistp = subprocess.Popen([qemu64llocatout, '-machine', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
qemu64lmachineout, qemu64lmachineerr = qemu64machinelistp.communicate();
qemu64lmachinelist = re.findall("^([\w\-\.]+)\s\s+([\w\(\)\+\,\. \-]+)\n", qemu64lmachineout, flags=re.MULTILINE);
qemu64lmachinenlist = twolistize(qemu64lmachinelist);
qemu64soundhwlistp = subprocess.Popen([qemu64llocatout, '-soundhw', 'help'], stdout=subprocess.PIPE, stderr=subprocess.PIPE);
...
qemu64cmdlaunch = subprocess.Popen(qemu64larglist, stdout=subprocess.PIPE, stderr=subprocess.PIPE);
