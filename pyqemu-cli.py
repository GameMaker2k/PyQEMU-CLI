...
qemuimglversion = re.findall(
    "^qemu-img version ([\w\_\. \-]+)\,", qemuimglhelpout, flags=re.MULTILINE)[0].strip()
...
qemu32lverfull = re.findall(
    "QEMU emulator version ([\w\_\.\+\(\) \-]+)\, Copyright", qemu32lhelpout, flags=re.MULTILINE)[0].strip()
...
qemu32larglist = arglistize(qemu32llocatout, ('-hda', '/dev/null'), ('-cdrom', '/home/cooldude2k/Emu/Minix3/minix_R3.3.0-588a35b.iso'), ('-boot', 'order=acd,once=d,menu=on'),
                            ('-cpu', qemu32lcpunlist['name']['reg'][9]), ('-machine', qemu32lmachinenlist['name']['reg'][16]), ('-soundhw', qemu32lsoundhwnlist['name']['reg'][8]), ('-sdl', None))
...
qemu64lverfull = re.findall(
    "QEMU emulator version ([\w\_\.\+\(\) \-]+)\, Copyright", qemu64lhelpout, flags=re.MULTILINE)[0].strip()
...
qemu64larglist = arglistize(qemu64llocatout, ('-hda', '/dev/null'), ('-cdrom', '/home/cooldude2k/Emu/Minix3/minix_R3.3.0-588a35b.iso'), ('-boot', 'order=acd,once=d,menu=on'),
                            ('-cpu', qemu64lcpunlist['name']['reg'][9]), ('-machine', qemu64lmachinenlist['name']['reg'][17]), ('-soundhw', qemu64lsoundhwnlist['name']['reg'][8]), ('-sdl', None))
print("PATH environment variable is set to "+os.environ["PATH"])
print("Python "+sys.version)
print(__project__+" version "+__version__)
